        ...
        <div className="w-full mb-1">
          ...
          <div className="text-[9.5px] leading-snug space-y-1 text-black">
            ...
            <p className="flex items-baseline gap-2 flex-wrap m-0">
              ...
              <span className="border-b border-black font-bold font-mono px-4 min-w-[170px] text-center pb-0.5 print:border-b-[1px]">
                {isEditing ? (
                  <input 
                    type="text"
                    value={formData.valorAvalado}
                    onChange={(e) => handleFieldChange('valorAvalado', e.target.value)}
                    className="bg-amber-50 font-bold font-mono text-center text-[9.5px] focus:outline-none w-full"
                    style={{ color: '#000000' }}
                  />
                ) : (
                  formData.valorAvalado
                )}
              </span>
