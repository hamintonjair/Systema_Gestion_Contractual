    ...
    <div className="w-full flex flex-col items-center select-text">
      ...
      <div className="w-full max-w-full overflow-x-auto pb-4 flex justify-start sm:justify-center">
        <div 
          ...
          className="min-w-[760px] max-w-[850px] w-full bg-white border-2 border-black p-4 sm:p-6 text-black shrink-0 print:p-[4mm] print:border-none print:w-[200mm] print:max-h-[268mm] print:overflow-hidden print:mx-auto text-[10px] sm:text-[10.5px] leading-tight select-text"
        ...
        <div className="w-full mb-1.5 print:mb-1.5">
          ...
          <div className="space-y-0.5 text-[10px]">
            ...
            {/* Tablas dobles lado a lado: con borde doble perimetral y líneas internas punteadas como en la imagen original */}
            <div className="flex items-start gap-4 pt-0.5 justify-start">
              
              {/* Tabla Izquierda: Valores (Más estrecha ~210px) con borde doble perimetral */}
              <div 
                className="w-[210px] border-[3px] border-double border-black bg-white shrink-0"
                style={{ border: '3px double #000000' }}
              >
                <table className="w-full border-collapse text-[9.5px]">
                  <tbody>
                    <tr className="border-b border-dotted border-black font-bold">
                      <td className="p-0.5 px-1 border-r border-dotted border-black w-[45%] text-[9px]">VALOR INICIAL</td>
                    ...
                    <tr className="border-b border-dotted border-black">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">Adición 1</td>
                    ...
                    <tr className="border-b border-dotted border-black">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">Adición 2</td>
                      <td className="p-0.5 px-1 text-right font-mono text-[9px]">
                        {isEditing ? (
                          <input 
                            type="text"
                    ...
                    <tr className="border-b border-dotted border-black">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">Adición 3</td>
                      <td className="p-0.5 px-1 text-right font-mono text-[9px]">
                        {isEditing ? (
                          <input 
                            type="text"
                    ...
                    <tr className="font-bold">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">VALOR TOTAL</td>
                      <td className="p-0.5 px-1 text-right font-mono flex items-center justify-between">
                        <span className="font-bold">$</span>
                        <span className="font-bold text-[9.5px]">
                          {isEditing ? (
              ...
              {/* Tabla Derecha: Prórrogas (Más estrecha ~220px) con borde doble perimetral */}
              <div 
                className="w-[220px] border-[3px] border-double border-black bg-white shrink-0"
                style={{ border: '3px double #000000' }}
              >
                <table className="w-full border-collapse text-[9.5px]">
                  <thead>
                    <tr className="border-b border-dotted border-black font-bold">
                      <th className="p-0.5 px-1 text-left border-r border-dotted border-black w-3/5 font-bold text-[9px]">Prórrogas</th>
                      <th className="p-0.5 px-1 text-center font-bold text-[9px]">Días</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-dotted border-black">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">Prórroga 1</td>
                    ...
                    <tr className="border-b border-dotted border-black">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">Prórroga 2</td>
                      <td className="p-0.5 px-1 text-center font-mono text-[9px]">
                        {isEditing ? (
                          <input 
                            type="text"
                    ...
                    <tr className="border-b border-dotted border-black">
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-[9px]">Prórroga 3</td>
                      <td className="p-0.5 px-1 text-center font-mono text-[9px]">
                        {isEditing ? (
                          <input 
                            type="text"
                    ...
                    <tr className="h-[15px]">
                      <td className="p-0.5 px-1 border-r border-dotted border-black">&nbsp;</td>
        ...
        <div className="w-full mb-1.5 print:mb-1.5">
          ...
          {/* Cuadro principal con borde doble perimetral y divisiones punteadas como en la imagen 1 */}
          <div 
            className="w-full border-[3px] border-double border-black bg-white"
            style={{ border: '3px double #000000' }}
          >
            <table className="w-full border-collapse table-fixed text-[9.5px]">
              <thead>
                <tr className="border-b border-dotted border-black font-bold">
                  <th className="w-[15%] p-1 print:p-0.5 text-center font-bold text-[9px] print:text-[8.5px] leading-tight border-r border-dotted border-black">
                    No. Certificado Disponibilidad Presupuestal
                  </th>
                  <th className="w-[14%] p-1 print:p-0.5 text-center font-bold text-[9px] print:text-[8.5px] leading-tight border-r border-dotted border-black">
                    No. Registro Presupuestal
                  </th>
                  <th className="w-[17%] p-1 print:p-0.5 text-center font-bold text-[9px] print:text-[8.5px] leading-tight border-r border-dotted border-black">
                    Fecha Registro Presupuestal
                  </th>
                  <th className="w-[24%] p-1 print:p-0.5 text-center font-bold text-[9px] print:text-[8.5px] leading-tight border-r border-dotted border-black">
                    Código Rubro Presupuestal
                  </th>
                  <th className="w-[30%] p-1 print:p-0.5 text-center font-bold text-[8.5px] print:text-[8px] leading-tight">
              ...
              <tbody>
                {[
                  {
                    cdpField: 'cdpNro' as const,
                    cdpVal: formData.cdpNro,
                    crpField: 'crpNro' as const,
                    crpVal: formData.crpNro,
                    fechaField: 'fechaRegistroPresupuestal' as const,
                    fechaVal: formData.fechaRegistroPresupuestal,
                    rubroField: 'codigoRubro' as const,
                    rubroVal: formData.codigoRubro,
                    valorField: 'valorRubro' as const,
                    valorVal: formData.valorRubro,
                  },
                  {
                    cdpField: 'cdpNro2' as const,
                    cdpVal: formData.cdpNro2,
                    crpField: 'crpNro2' as const,
                    crpVal: formData.crpNro2,
                    fechaField: 'fechaRegistroPresupuestal2' as const,
                    fechaVal: formData.fechaRegistroPresupuestal2,
                    rubroField: 'codigoRubro2' as const,
                    rubroVal: formData.codigoRubro2,
                    valorField: 'valorRubro2' as const,
                    valorVal: formData.valorRubro2,
                  },
                  {
                    cdpField: 'cdpNro3' as const,
                    cdpVal: formData.cdpNro3,
                    crpField: 'crpNro3' as const,
                    crpVal: formData.crpNro3,
                    fechaField: 'fechaRegistroPresupuestal3' as const,
                    fechaVal: formData.fechaRegistroPresupuestal3,
                    rubroField: 'codigoRubro3' as const,
                    rubroVal: formData.codigoRubro3,
                    valorField: 'valorRubro3' as const,
                    valorVal: formData.valorRubro3,
                  },
                  {
                    cdpField: 'cdpNro4' as const,
                    cdpVal: formData.cdpNro4,
                    crpField: 'crpNro4' as const,
                    crpVal: formData.crpNro4,
                    fechaField: 'fechaRegistroPresupuestal4' as const,
                    fechaVal: formData.fechaRegistroPresupuestal4,
                    rubroField: 'codigoRubro4' as const,
                    rubroVal: formData.codigoRubro4,
                    valorField: 'valorRubro4' as const,
                    valorVal: formData.valorRubro4,
                  },
                ].map((row, idx, arr) => {
                  const isLastRow = idx === arr.length - 1;
                  const borderBottomClass = isLastRow ? '' : 'border-b border-dotted border-black';
                  return (
                    <tr key={idx} className={`h-[18px] print:h-[15px] ${borderBottomClass}`}>
                      {/* Col 1: CDP */}
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-center font-mono text-[10px] print:text-[8.5px]">
                        {isEditing ? (
                          <input 
                            type="text"
                            value={row.cdpVal ?? ''}
                            onChange={(e) => handleFieldChange(row.cdpField, e.target.value)}
                      ...
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-center font-mono text-[10px] print:text-[8.5px]">
                        {isEditing ? (
                          <input 
                            type="text"
                            value={row.crpVal ?? ''}
                            onChange={(e) => handleFieldChange(row.crpField, e.target.value)}
                            className="w-full h-full bg-amber-50 text-center font-mono text-black text-[10px] print:text-[8.5px] focus:outline-none focus:bg-amber-100"
                            style={{ color: '#000000' }}
                          />
                        ) : (
                      ...
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-center font-mono text-[10px] print:text-[8.5px]">
                        {isEditing ? (
                          <input 
                            type="text"
                            value={row.fechaVal ?? ''}
                            onChange={(e) => handleFieldChange(row.fechaField, e.target.value)}
                            className="w-full h-full bg-amber-50 text-center font-mono text-black text-[10px] print:text-[8.5px] focus:outline-none focus:bg-amber-100"
                            style={{ color: '#000000' }}
                          />
                        ) : (
                      ...
                      {/* Col 4: Código Rubro */}
                      <td className="p-0.5 px-1 border-r border-dotted border-black text-center font-mono text-[9.5px] print:text-[8.5px]">
                        {isEditing ? (
                          <input 
                            type="text"
                            value={row.rubroVal ?? ''}
                            onChange={(e) => handleFieldChange(row.rubroField, e.target.value)}
                      ...
                      {/* Col 5: Valor Rubro */}
                      <td className="p-0.5 px-1 text-right font-mono text-[10px] print:text-[8.5px]">
                        {isEditing ? (
                          <input 
                            type="text"
                            value={quitarDecimales(row.valorVal ?? '')}
                            onChange={(e) => handleFieldChange(row.valorField, e.target.value)}
                            className="w-full h-full bg-amber-50 text-right font-mono text-black text-[10px] print:text-[8.5px] focus:outline-none focus:bg-amber-100 pr-1"
                            style={{ color: '#000000' }}
                          />
                        ) : (
                          row.valorVal === '-' ? (
